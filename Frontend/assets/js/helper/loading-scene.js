export class LoaderScene extends Phaser.Scene {
  constructor() {
    ...
    this.assetsToLoad = []; // Array of assets to load
    this.nextSceneKey = null; // Key of the next scene to start
    this.loadingText = null; // Declare the text object as a property
  }
  ...
  createProgressBar() {
    ...
    progressBox.fillStyle(0x000103, 1.0); // Dark background color. 1.0 is fully opaque
    progressBox.fillRoundedRect(width / 4, height / 2 - 25, width / 2, 100, 20); // x, y, width, height, radius
