...
export const SceneTwo = new Phaser.Class({
  ...
  create: function () {
    ...
    poster.setDisplaySize(600, 600); // Explicitly set width and height (pixels)
    ...
    this.add
      .text(
        ...
        "Meet Femme: a dazzling troublemaker... a sly femme fatale... beautiful but dangerous, sharp-tongued villainess who charms and deceives in equal measure. She always plays for herself.",
        {
          fontSize: "48px",
          color: "#000000",
        ...
        "LoaderScene",
        {
          ...
          assets: [
            ...
            },
            {
              ...
              frameWidth: 375, // Pass the frame width
              frameHeight: 666, // Pass the frame height
            },
            {
              type: "spritesheet",
              key: "johnny",
              path: "assets/graphics/sceneThree/johnny_walks.png",
              frameWidth: 247, // Pass the frame width
              frameHeight: 352, // Pass the frame height
            },
            {
              type: "image",
              key: "chat-icon",
